            ...
            {[
              {
                ...
                desc: "We visit your site, understand your requirements, and assess dimensions, load, and environmental factors.",
                icon: <Users className="w-5 h-5" />,
              },
              {
                step: "02",
                title: "Design & Engineering",
                desc: "Our team produces detailed structural drawings and material specifications tailored to your project.",
                icon: <Building className="w-5 h-5" />,
              },
              {
                step: "03",
                title: "In-House Manufacturing",
                desc: "All components are fabricated at our Al Ain facility using CNC machines, PVC welders, and precision tools.",
                icon: <Wrench className="w-5 h-5" />,
              },
              {
                step: "04",
                title: "Installation & Handover",
                desc: "Our field crews install, inspect, and hand over with full quality assurance and post-installation support.",
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-white/8 border border-white/10 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-blue-500 transition-colors"
                  />
                </div>
                <div>
                  <label className="text-slate-400 text-xs font-medium block mb-1.5">Phone Number</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="text-slate-400 text-xs font-medium block mb-1.5">Service Required</label>
                  <select className="w-full px-4 py-2.5 rounded-lg bg-white/8 border border-white/10 text-slate-400 text-sm focus:outline-none focus:border-blue-500 transition-colors appearance-none">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-white/8 border border-white/10 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-blue-500 transition-colors resize-none"
                  />
                </div>
                <Link
                  href="/contact"
                  className="flex items-center justify-center w-full gap-2 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-blue-900/50"
                >
                  <Mail className="w-4 h-4" />
                  Send Enquiry
                </Link>
